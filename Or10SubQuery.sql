...
select * from employees where first_name+(서브쿼리);
*/
...
-- 3. 둘 중 하나만 만족하면 인출할 것이므로 any를 이용해 서브쿼리를 작성
...
/********************************************************************/
/*
01.사원번호가 7782인 사원과 담당 업무가 같은 
사원을 표시(사원이름과 담당 업무)하시오.
*/
...
/*
    ...
    서브쿼리를 만들 수 있지만 만약 결과가 2개 이상이라면 복수행
    연산자인 all이나 any를 추가해야 한다.
*/
...
/*
10.담당 업무가 MANAGER인 사원이 소속된 부서와 동일한 부서의 
사원을 표시하시오.
*/
